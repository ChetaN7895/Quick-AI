    ...
    >
      <div className="text-center mb-6">
        ...
        >
          ...
          <span className="text-primary text-purple-500"> AI Tools </span>
        </h1>
        <p
          className="mt-4 max-w-xs sm:max-w-lg 2xl:max-w-xl m-auto
      max-sm:text-xs text-grey-600"
        >
          Transform your content creation with our suitr of premium AI Tools.
      ...
      <div className="flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs">
        <button
          onClick={() => navigate("/ai")}
          className="bg-primary bg-blue-600 text-white px-10 py-3 rounded-lg hover:bg-blue-700 transition'
